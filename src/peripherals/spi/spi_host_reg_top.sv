...
module spi_host_reg_top (
  input clk_i,
  input rst_ni,
  input  tluh_32_pkg::tl_h2d_t tl_i,
  output tluh_32_pkg::tl_d2h_t tl_o,

  // Output port for window
  output tluh_32_pkg::tl_h2d_t tl_win_o  [2],
  input  tluh_32_pkg::tl_d2h_t tl_win_i  [2],
  ...
  tluh_32_pkg::tl_h2d_t tl_socket_h2d [3];
  tluh_32_pkg::tl_d2h_t tl_socket_d2h [3];
